...
public:
	...
	int getSubType() {
		return ((int (*)(LogicAccessoryData*))(base + 0x82A904))(this);
	}
	String* getAreaEffect() {
		return ((String * (*)(LogicAccessoryData*))(base + 0x82A9F4))(this);
	}
	String* getPetAreaEffect() {
		return ((String * (*)(LogicAccessoryData*))(base + 0x82AA04))(this);
	}
	int getShieldPercent() {
		return ((int (*)(LogicAccessoryData*))(base + 0x82AAA4))(this);
	}
	int getShieldTicks() {
		return ((int (*)(LogicAccessoryData*))(base + 0x82AAB4))(this);
	}
	int getSpeedBoost() {
		return ((int (*)(LogicAccessoryData*))(base + 0x82AAC4))(this);
	}
